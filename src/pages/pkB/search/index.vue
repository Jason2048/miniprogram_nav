...
import data5 from '../../../mock/more/5.js'
import data6 from '../../../mock/more/6.js'
import data7 from '../../../mock/more/7.js'
import data8 from '../../../mock/more/8.js'
export default {
  data () {
    return {
      categoryId:null,
  ...
  methods: {
    init(){
      ...
      let categoryList=[data5,data6,data7,data8]
      this.categoryObj = categoryList[this.categoryId-5]

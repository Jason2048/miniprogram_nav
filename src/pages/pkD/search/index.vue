...
import data13 from '../../../mock/more/13.js'
import data14 from '../../../mock/more/14.js'
import data15 from '../../../mock/more/15.js'
export default {
  data () {
    return {
      categoryId:null,
  ...
  methods: {
    init(){
      ...
      let categoryList=[data13,data14,data15]
      this.categoryObj = categoryList[this.categoryId-13]

...
import data9 from '../../../mock/more/9.js'
import data10 from '../../../mock/more/10.js'
import data11 from '../../../mock/more/11.js'
import data12 from '../../../mock/more/12.js'
export default {
  data () {
    return {
      categoryId:null,
  ...
  methods: {
    init(){
      ...
      let categoryList=[data9,data10,data11,data12]
      this.categoryObj = categoryList[this.categoryId-9]
